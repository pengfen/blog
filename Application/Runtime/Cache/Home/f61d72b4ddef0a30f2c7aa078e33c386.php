				...
				<form action=<?php echo U('Register/doregister');?> method="post" id='reg_form' onsubmit="return formcheck()">
				  ...
				  <div class="row">
				    ...
				    <input type="text" name='code'  class="form-control" id="exampleInputPassword1" placeholder="">
				  	...
				  	<div class="col-md-4" style="padding:20px 0px;"><img src='/blog/index.php/Home/Register/verifyImg' id='img'/>
				  	</div>
				  	<div class="col-md-4" style="padding:30px 0px;">
				  		<a href="javascript:void(0);" onclick="document.getElementById('img').src='/blog/index.php/Home/Register/verifyImg'" ><i>看不清</i></a>
				  	</div>
				  </div>
